...
function HomePage() {
  ...
  function handlePosition(e) {
    ...
    const deltaYCheck =
      deltaY < 0 ? (deltaY < -10 ? -10 : deltaY) : deltaY > 10 ? 10 : deltaY;
    ...
    <>
      <div className="wrapper">
        <div className="poistion-relative Herocontainer">
          <div
            className="HomeBackground position-absolute w-100   "
            style={{
              transform: `translate(${imagePos.xPos}px,${imagePos.yPos}px) scale(1)`,
            }}
          ...
          <div className="container position-relative w-25  latestBooks">
            <div className="row h-75 justify-content-lg-start align-items-center">
              {topFourMovies.map((movie) => {
                return (
                  <HeroSectionBooksComponent
                    cardTilte={movie.title}
        ...
        <div className="container bookCategContianer    pb-5">
          <div className="row">
            <div className="col-lg-6 col-md-6 col-sm-12 ">
              <h2 className="mb-5 mt-5" style={{ color: "#C12748" }}>
                New Arrivals{" "}
              </h2>
            </div>
            ...
            {testMovies.map((movie) => {
              return (
                <HomePageBookComponent
                  cardTilte={movie.overview.slice(0, 45) + "..."}
                  cardSrc={`https://image.tmdb.org/t/p/w500/${movie.poster_path}`}
                  footer={movie.release_date}
                  id={movie.id}
                ></HomePageBookComponent>
